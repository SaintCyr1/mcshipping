...
class Mcshipping extends CarrierModule
{
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MCSHIPPING_LIVE_MODE', false);
    ...
    {
        Configuration::deleteByName('MCSHIPPING_LIVE_MODE');
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'name' => 'MCSHIPPING_ACCOUNT_EMAIL',
                        'label' => $this->l('Email'),
                    ),
                    array(
                        'type' => 'password',
                        'name' => 'MCSHIPPING_ACCOUNT_PASSWORD',
    ...
    {
        return array(
            'MCSHIPPING_LIVE_MODE' => Configuration::get('MCSHIPPING_LIVE_MODE', true),
            'MCSHIPPING_ACCOUNT_EMAIL' => Configuration::get('MCSHIPPING_ACCOUNT_EMAIL', 'contact@prestashop.com'),
            'MCSHIPPING_ACCOUNT_PASSWORD' => Configuration::get('MCSHIPPING_ACCOUNT_PASSWORD', null),
        );
    }
